...
class ReferACreditCardPage extends StatefulWidget {
  const ReferACreditCardPage({super.key});

  @override
  _ReferACreditCardPageState createState() => _ReferACreditCardPageState();
}

class _ReferACreditCardPageState extends State<ReferACreditCardPage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: const CommonAppbar(text: 'Refer a Credit Card'),
        body: ListView(
            ...
            Row(
              children: [
                Checkbox(
                 ...
                 Text('I hereby accept  ',style: IciciBankFontTheme.textTheme.labelMedium,),
                GestureDetector(
                  onTap: () {
