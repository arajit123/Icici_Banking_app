...
class DataCardItemPage extends StatefulWidget {
  const DataCardItemPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DataCardItemPageState createState() => _DataCardItemPageState();
}

class _DataCardItemPageState extends State<DataCardItemPage> {
